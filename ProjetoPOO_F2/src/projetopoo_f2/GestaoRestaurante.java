...
public class GestaoRestaurante {
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            switch(opcao){
                case 1:
                    System.out.println(restaurante.registarProduto());
                    break;
                case 2:
                    System.out.println(restaurante.toStringProdutos());
                break;
                case 3:
                    System.out.println(restaurante.solicitarMesa());
                break;
                case 4:
                    System.out.println(restaurante.toStringMesas());
                    break;
                case 5:
                    System.out.println(restaurante.adicionarItemPedido());
                    break;
                case 6:
                    System.out.println(restaurante.servirPedido());
                    break;
                case 7:
                    System.out.println(restaurante.fecharPedido());
                    break;
                case 8:
                    System.out.println(restaurante.toStringHistoricoPedidos());
                    break;
                case 9:
